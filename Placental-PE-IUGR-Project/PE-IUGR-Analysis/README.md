# PE_IUGR_DNAmProfiling_Project

PE_DifferentialMethylation File- Differential methylation analysis in the discovery cohort

CoxValidation File- Validation of EOPE hits from the discovery cohort in the validation cohort

FDR_DelatBeta_ThreholdPLot- Source code for the plot comparing different FDR and Delta Beta thresholds in the discovery cohort with the rate of concordance/reproducibility in the validation cohort.
